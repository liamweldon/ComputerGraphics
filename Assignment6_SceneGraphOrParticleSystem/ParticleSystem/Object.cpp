...
vertices(QVector<QVector3D>()), texCoords(QVector<QVector2D>()), vertexIndices(QVector<unsigned int>()), indexedVertices(QVector<VertexData>()), rotationAxis_(0.0, 1.0, 0.0), rotationSpeed_(0.25)
{
...
void Object::draw(const QMatrix4x4& world, const QMatrix4x4& view, const QMatrix4x4& projection, const QMatrix4x4& model)
{

    QMatrix4x4 modelMat = world * model;
