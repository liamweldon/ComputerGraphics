...
void UnitQuad::update(const qint64 msSinceLastFrame)
{
    ...
    shader_.setUniformValue("pointLights[1].color", 0.5f, 0.0f, 1.0f);
    shader_.setUniformValue("pointLights[1].position", QVector3D(0.5f, 0.5f, -2.0f));
    ...
    shader_.setUniformValue("pointLights[2].color", 0.0f, 1.0f, 0.5f);
    shader_.setUniformValue("pointLights[2].position", QVector3D(0.5f, 0.5f, -5.0f));
    shader_.setUniformValue("pointLights[2].ambientIntensity", 0.2f);
    shader_.setUniformValue("pointLights[2].specularStrength", 0.2f);
